...
clear;clear;clear
echo -e "${BICyan}----------------------------------------------------------${NC}"
echo -e "\033[96;1m          WELCOME TO SRICPT BY ADIJAYA TUNNELING             \033[0m"
echo -e "${BICyan}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="http://siluman.my.id/"
CONFIG="https://raw.githubusercontent.com/Garut-SisiBukit/fodder/main/"
start=$(date +%s)
secs_to_human() {
...
echo "ADIJAYA TUNNELING" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
echo "ADIJAYA TUNNELING" > /etc/xray/username
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/AdijayaTunneling/ip/main/ip | grep $ipsaya | awk '{print $3}')
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>◇━━━━━━━━━━━━━━━━━◇</code>
<b> 🧿 NOTIF INSTALL ASGAR2 🧿</b>
<code>◇━━━━━━━━━━━━━━━━━◇</code>
<code>🧿ID     : </code><code>$USRSC</code>
<code>🧿Domain : </code><code>$domain</code>
<code>🧿Isp    : </code><code>$(cat /etc/xray/isp)</code>
<code>🧿Region : </code><code>$(cat /etc/xray/city)</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ADMIN BOT","url":"https://t.me/AJSvpnjoss"},{"text":"🧿CHAT WA","url":"https://wa.me/6281214726068"}]]}'
...
wget http://siluman.my.id/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY ADIJAYA STORE VPN"
clear
...
print_success "NOOBZVPNS BY ADIJAYA STORE"
}
...
wget -q -O /usr/bin/enc "http://siluman.my.id/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget http://siluman.my.id/Cfg/m-noobz 
